...
use Mhmmdkyr\Modules\Exceptions\InvalidAssetPath;
use Mhmmdkyr\Modules\Exceptions\ModuleNotFoundException;
use Mhmmdkyr\Modules\Process\Installer;
use Mhmmdkyr\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @param string $args
     * @param string $path
     * @return \Mhmmdkyr\Modules\Module
     */
     ...
     * @return string
     * @throws \Mhmmdkyr\Modules\Exceptions\ModuleNotFoundException
     */
